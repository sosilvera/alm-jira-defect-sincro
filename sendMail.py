...
def buildMail(date, passed, fail, bodyMailF):
    html = f"""
        ...
        <br><br>
        <p>Para el informe completo visitar: <a href="http://file-server:8080/proyect/proyect/{date}_200000/proyect_{date}.html" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="0">Informe</a><br aria-hidden="true" />
